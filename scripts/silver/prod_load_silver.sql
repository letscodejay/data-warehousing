...
BEGIN
    ...
    BEGIN TRY
      ...
      SELECT DISTINCT 
          ...
          CASE 
              WHEN UPPER(LTRIM(RTRIM(REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), '')))) 
                  IN ('US', 'USA', 'UNITED STATES', 'U.S.', 'U.S.A.') 
                  THEN 'United States'

              WHEN UPPER(LTRIM(RTRIM(REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), '')))) 
                  IN ('UK', 'UNITED KINGDOM', 'GB', 'GREAT BRITAIN') 
                  THEN 'United Kingdom'
      ...
      -- cleaned silver.erp_px_car_g1v2 table
      ...
      SELECT DISTINCT 
          ...
          subcat,
          CASE 
              WHEN UPPER(LTRIM(RTRIM(REPLACE(REPLACE(maintenance, CHAR(13), ''), CHAR(10), '')))) = 'YES'
                  THEN 'Yes'
              WHEN UPPER(LTRIM(RTRIM(REPLACE(REPLACE(maintenance, CHAR(13), ''), CHAR(10), '')))) = 'NO'
                  THEN 'No'
              ELSE 'n/a'
          END AS maintenance
